...
| <a name="module_aws_iam_grafana"></a> [aws\_iam\_grafana](#module\_aws\_iam\_grafana)                                                                          | ../modules/aws-iam-eks-trusted      | n/a     |
...
| <a name="module_monitoring_namespace"></a> [monitoring\_namespace](#module\_monitoring\_namespace)                                                             | ../modules/kubernetes-namespace     | n/a     |
...
| <a name="output_grafana_domain_name"></a> [grafana\_domain\_name](#output\_grafana\_domain\_name)                                         | Grafana dashboards address                               |
| <a name="output_kibana_domain_name"></a> [kibana\_domain\_name](#output\_kibana\_domain\_name)                                            | Kibana dashboards address                                |
| <a name="output_prometheus_domain_name"></a> [prometheus\_domain\_name](#output\_prometheus\_domain\_name)                                | Prometheus ui address                                    |
<!-- END_TF_DOCS -->
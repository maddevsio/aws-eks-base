...
output "node_group_addons_iam_instance_profile_id" {
  value = var.karpenter_enabled ? module.eks.self_managed_node_groups["addons"].iam_instance_profile_id : ""
}

output "node_group_addons_iam_role_arn" {
  value = var.karpenter_enabled ? module.eks.self_managed_node_groups["addons"].iam_role_arn : ""
}
